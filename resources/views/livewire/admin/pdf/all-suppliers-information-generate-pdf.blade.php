...
<head>
    ...
    <title>TEMO</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/TEMO-logo.jpg')}}">
    <style>
        body{
...
<body>
    ...
    <div class="container">
        ...
        <div class="body-section">
            <div class="row">
                <div class="">
                    <h2 class="heading">Suppliers Information</h2>
                </div>
            </div>
        </div>

        <div class="body-section">
            <h3 class="heading">All Suppliers Information</h3>
            <br>
