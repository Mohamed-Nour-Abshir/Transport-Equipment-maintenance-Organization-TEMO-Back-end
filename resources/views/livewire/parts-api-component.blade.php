          ...
          <tbody>
            ...
            {{-- @if ($item->fiscal_year === date('d-m-Y',strtotime($fiscalYear->start_date))) --}}
                <tr>
                    ...
                    <a href="{{route('deletePartsInfo',$item->id)}}" onclick="confirm('Are you sure to Delete This Information?')" title="delete"><i class="fas fa-remove  fa-1x text-danger"></i></a>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
        <form action="{{route('addPartsInformation')}}" method="POST">
            @csrf
            <div class="form-group mb-3">
                <label for="vehicle-code" class="form-label">Vehicle Code</label>
                <select class="form-select bg-danger" id="vehicle-code" aria-label="Default select example" name="vehicle_code">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text"  id="vehicle_id" class="form-control" name="vehicle_id" style="display: none;">
            <div class="form-group mb-3">
 ...
 $('#vehicle-code').change(function(e)  {
     ...
     $.ajax({
         ...
         success:function(data){
             ...
             $("form").find('#vehicle_id').val(data.id);
         },
         error:function(){
