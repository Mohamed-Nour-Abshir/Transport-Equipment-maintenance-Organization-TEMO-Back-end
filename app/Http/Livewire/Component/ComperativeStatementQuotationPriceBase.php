...
class ComperativeStatementQuotationPriceBase extends Component
{
    ...
    public function render()
    {
        ...
        if (request('vehicle_name') || request('from_date') || request('to_date')) {
            ...
            return view('livewire.component.comperative-statement-quotation-price-base', compact('quotations', 'minNumber', 'searchVehicleName', 'searchFromDate', 'searchToDate', 'vehicles', 'fiscal_year', 'parts', 'minimumPrices'))->layout('layouts.base');
        } else {
