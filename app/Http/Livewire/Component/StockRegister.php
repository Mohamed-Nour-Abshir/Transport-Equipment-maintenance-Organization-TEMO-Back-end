...
class StockRegister extends Component
{
    public function render()
    {
        ...
        if (request('vehicle_type') || request('from_date') || request('to_date')) {
            ...
            $quotations = WorkOrder::where('vehicle_type', $searchVehicleName)->get();
            ...
            return view('livewire.component.stock-register', compact('quotations', 'vehicles', 'fiscal_year', 'searchVehicleName', 'searchFromDate', 'searchToDate', 'sum','fiscalYear'))->layout('layouts.base');
        } else {
        ...
        return view('livewire.component.stock-register', ['quotations' => $quotations, 'vehicles' => $vehicles, 'fiscal_year' => $fiscal_year, 'fiscalYear' => $fiscalYear])->layout('layouts.base');
    }
}
